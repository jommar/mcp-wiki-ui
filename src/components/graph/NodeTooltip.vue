...
<template>
  ...
  >
    ...
    <div class="flex gap-2 mb-2">
      <span
        class="flex items-center gap-1 text-[11px] font-semibold font-mono px-2 py-0.5 rounded-full border"
    ...
    <p
      v-else
      class="text-[12px] text-text leading-snug whitespace-pre-wrap break-words line-clamp-3"
    >
