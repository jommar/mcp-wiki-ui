      ...
      >
        ...
        >
          ...
          <div class="flex items-center gap-3 px-5 py-4 border-b border-border">
            ...
            />
            <kbd
              class="px-1.5 py-0.5 rounded text-[10px] border border-border bg-elevated text-muted font-mono flex-shrink-0"
              >ESC</kbd
            >
          </div>
          ...
          <div class="flex-1 overflow-y-auto p-2">
            ...
            >
              <div
                class="w-4 h-4 rounded-full border-2 border-border border-t-accent animate-spin"
              />
              Searching…
            </div>
            <div
              v-else-if="query && !results.length"
              class="text-center py-8 text-muted text-[13px]"
            >
          ...
          <!-- Footer -->
          <div
            class="flex items-center gap-4 px-5 py-2.5 border-t border-border text-[11px] text-muted"
          >
            <span
              ><kbd class="font-mono border border-border rounded px-1 bg-elevated">↑↓</kbd>
              navigate</span
            >
            <span
              ><kbd class="font-mono border border-border rounded px-1 bg-elevated">↵</kbd>
            ...
            >
            <span
              ><kbd class="font-mono border border-border rounded px-1 bg-elevated">ESC</kbd>
              close</span
            >
            <span v-if="results.length" class="ml-auto"
